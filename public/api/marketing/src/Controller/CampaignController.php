...
final class CampaignController
{
    ...
    public function store(Request $request): array
    {
        ...
        $payload = $request->only([
            ...
            'owner_user_id', 'create_crm_leads', 'b2b_offices_only',
    ...
    public function replace(Request $request): array
    {
        ...
        $payload = $request->only([
            ...
            'agency_note', 'b2b_webshop_enabled', 'show_web_shop', 'pos_survey_enabled', 'pos_questions',
            'create_crm_leads', 'b2b_offices_only', 'image_url', 'focal_point_y', 'image_fit', 'shop_ids', 'shop_targets', 'shop_item_targets', 'channels',
            'color_primary_hex', 'color_secondary_hex', 'color_accent_hex', 'color_ink_hex',
    ...
    public function update(Request $request): array
    {
        ...
        $payload = $request->only([
            ...
            'create_crm_leads', 'b2b_offices_only', 'image_url',
        ]);
